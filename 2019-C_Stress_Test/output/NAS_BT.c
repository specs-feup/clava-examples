...
void clava_call_graph() {
   FILE *log_file_369 = fopen("/home/specs/jbispo/repos/clava-examples/2019-C_Stress_Test/output/NAS_BT.dot", "w+");
   if (log_file_369 == NULL)
   {
       printf("Error opening file /home/specs/jbispo/repos/clava-examples/2019-C_Stress_Test/output/NAS_BT.dot\n");
       exit(1);
   } 
   fprintf(log_file_369, "digraph dynamic_call_graph {\n\n");
   if(clava_dcg_global[0] != 0) {
      fprintf(log_file_369, "	main -> printf [label=\"%d\"];\n", clava_dcg_global[0]);
   }
   if(clava_dcg_global[1] != 0) {
      fprintf(log_file_369, "	main -> set_constants [label=\"%d\"];\n", clava_dcg_global[1]);
   }
   if(clava_dcg_global[2] != 0) {
      fprintf(log_file_369, "	main -> timer_clear [label=\"%d\"];\n", clava_dcg_global[2]);
   }
   if(clava_dcg_global[3] != 0) {
      fprintf(log_file_369, "	main -> initialize [label=\"%d\"];\n", clava_dcg_global[3]);
   }
   if(clava_dcg_global[4] != 0) {
      fprintf(log_file_369, "	main -> exact_rhs [label=\"%d\"];\n", clava_dcg_global[4]);
   }
   if(clava_dcg_global[5] != 0) {
      fprintf(log_file_369, "	main -> adi [label=\"%d\"];\n", clava_dcg_global[5]);
   }
   if(clava_dcg_global[6] != 0) {
      fprintf(log_file_369, "	main -> timer_start [label=\"%d\"];\n", clava_dcg_global[6]);
   }
   if(clava_dcg_global[7] != 0) {
      fprintf(log_file_369, "	main -> timer_stop [label=\"%d\"];\n", clava_dcg_global[7]);
   }
   if(clava_dcg_global[8] != 0) {
      fprintf(log_file_369, "	main -> timer_read [label=\"%d\"];\n", clava_dcg_global[8]);
   }
   if(clava_dcg_global[9] != 0) {
      fprintf(log_file_369, "	main -> verify [label=\"%d\"];\n", clava_dcg_global[9]);
   }
   if(clava_dcg_global[10] != 0) {
      fprintf(log_file_369, "	main -> print_results [label=\"%d\"];\n", clava_dcg_global[10]);
   }
   if(clava_dcg_global[11] != 0) {
      fprintf(log_file_369, "	adi -> compute_rhs [label=\"%d\"];\n", clava_dcg_global[11]);
   }
   if(clava_dcg_global[12] != 0) {
      fprintf(log_file_369, "	adi -> x_solve [label=\"%d\"];\n", clava_dcg_global[12]);
   }
   if(clava_dcg_global[13] != 0) {
      fprintf(log_file_369, "	adi -> y_solve [label=\"%d\"];\n", clava_dcg_global[13]);
   }
   if(clava_dcg_global[14] != 0) {
      fprintf(log_file_369, "	adi -> z_solve [label=\"%d\"];\n", clava_dcg_global[14]);
   }
   if(clava_dcg_global[15] != 0) {
      fprintf(log_file_369, "	adi -> add [label=\"%d\"];\n", clava_dcg_global[15]);
   }
   if(clava_dcg_global[16] != 0) {
      fprintf(log_file_369, "	error_norm -> exact_solution [label=\"%d\"];\n", clava_dcg_global[16]);
   }
   if(clava_dcg_global[17] != 0) {
      fprintf(log_file_369, "	error_norm -> sqrt [label=\"%d\"];\n", clava_dcg_global[17]);
   }
   if(clava_dcg_global[18] != 0) {
      fprintf(log_file_369, "	rhs_norm -> sqrt [label=\"%d\"];\n", clava_dcg_global[18]);
   }
   if(clava_dcg_global[19] != 0) {
      fprintf(log_file_369, "	exact_rhs -> exact_solution [label=\"%d\"];\n", clava_dcg_global[19]);
   }
   if(clava_dcg_global[20] != 0) {
      fprintf(log_file_369, "	initialize -> exact_solution [label=\"%d\"];\n", clava_dcg_global[20]);
   }
   if(clava_dcg_global[21] != 0) {
      fprintf(log_file_369, "	verify -> error_norm [label=\"%d\"];\n", clava_dcg_global[21]);
   }
   if(clava_dcg_global[22] != 0) {
      fprintf(log_file_369, "	verify -> compute_rhs [label=\"%d\"];\n", clava_dcg_global[22]);
   }
   if(clava_dcg_global[23] != 0) {
      fprintf(log_file_369, "	verify -> rhs_norm [label=\"%d\"];\n", clava_dcg_global[23]);
   }
   if(clava_dcg_global[24] != 0) {
      fprintf(log_file_369, "	verify -> fabs [label=\"%d\"];\n", clava_dcg_global[24]);
   }
   if(clava_dcg_global[25] != 0) {
      fprintf(log_file_369, "	verify -> printf [label=\"%d\"];\n", clava_dcg_global[25]);
   }
   if(clava_dcg_global[26] != 0) {
      fprintf(log_file_369, "	x_solve -> lhsinit [label=\"%d\"];\n", clava_dcg_global[26]);
   }
   if(clava_dcg_global[27] != 0) {
      fprintf(log_file_369, "	x_solve -> binvcrhs [label=\"%d\"];\n", clava_dcg_global[27]);
   }
   if(clava_dcg_global[28] != 0) {
      fprintf(log_file_369, "	x_solve -> matvec_sub [label=\"%d\"];\n", clava_dcg_global[28]);
   }
   if(clava_dcg_global[29] != 0) {
      fprintf(log_file_369, "	x_solve -> matmul_sub [label=\"%d\"];\n", clava_dcg_global[29]);
   }
   if(clava_dcg_global[30] != 0) {
      fprintf(log_file_369, "	x_solve -> binvrhs [label=\"%d\"];\n", clava_dcg_global[30]);
   }
   if(clava_dcg_global[31] != 0) {
      fprintf(log_file_369, "	y_solve -> lhsinit [label=\"%d\"];\n", clava_dcg_global[31]);
   }
   if(clava_dcg_global[32] != 0) {
      fprintf(log_file_369, "	y_solve -> binvcrhs [label=\"%d\"];\n", clava_dcg_global[32]);
   }
   if(clava_dcg_global[33] != 0) {
      fprintf(log_file_369, "	y_solve -> matvec_sub [label=\"%d\"];\n", clava_dcg_global[33]);
   }
   if(clava_dcg_global[34] != 0) {
      fprintf(log_file_369, "	y_solve -> matmul_sub [label=\"%d\"];\n", clava_dcg_global[34]);
   }
   if(clava_dcg_global[35] != 0) {
      fprintf(log_file_369, "	y_solve -> binvrhs [label=\"%d\"];\n", clava_dcg_global[35]);
   }
   if(clava_dcg_global[36] != 0) {
      fprintf(log_file_369, "	z_solve -> lhsinit [label=\"%d\"];\n", clava_dcg_global[36]);
   }
   if(clava_dcg_global[37] != 0) {
      fprintf(log_file_369, "	z_solve -> binvcrhs [label=\"%d\"];\n", clava_dcg_global[37]);
   }
   if(clava_dcg_global[38] != 0) {
      fprintf(log_file_369, "	z_solve -> matvec_sub [label=\"%d\"];\n", clava_dcg_global[38]);
   }
   if(clava_dcg_global[39] != 0) {
      fprintf(log_file_369, "	z_solve -> matmul_sub [label=\"%d\"];\n", clava_dcg_global[39]);
   }
   if(clava_dcg_global[40] != 0) {
      fprintf(log_file_369, "	z_solve -> binvrhs [label=\"%d\"];\n", clava_dcg_global[40]);
   }
   if(clava_dcg_global[41] != 0) {
      fprintf(log_file_369, "	print_results -> printf [label=\"%d\"];\n", clava_dcg_global[41]);
   }
   if(clava_dcg_global[42] != 0) {
      fprintf(log_file_369, "	print_results -> sprintf [label=\"%d\"];\n", clava_dcg_global[42]);
   }
   if(clava_dcg_global[43] != 0) {
      fprintf(log_file_369, "	print_results -> pow [label=\"%d\"];\n", clava_dcg_global[43]);
   }
   if(clava_dcg_global[44] != 0) {
      fprintf(log_file_369, "	wtime -> gettimeofday [label=\"%d\"];\n", clava_dcg_global[44]);
   }
   if(clava_dcg_global[45] != 0) {
      fprintf(log_file_369, "	elapsed_time -> wtime [label=\"%d\"];\n", clava_dcg_global[45]);
   }
   if(clava_dcg_global[46] != 0) {
      fprintf(log_file_369, "	timer_start -> elapsed_time [label=\"%d\"];\n", clava_dcg_global[46]);
   }
   if(clava_dcg_global[47] != 0) {
      fprintf(log_file_369, "	timer_stop -> elapsed_time [label=\"%d\"];\n", clava_dcg_global[47]);
   }
   fprintf(log_file_369, "}\n");
   fclose(log_file_369);
}
